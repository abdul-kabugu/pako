...
export const SUPABSE_APP_URL =   process.env.NEXT_PUBLIC_SUPABASE_URL
export const SUPABSE_API_KEY  =  process.env.NEXT_PUBLIC_SUPABASE_API_KEY
...
export const WEBSITE_URL = "https://www.paxfy.xyz"
  ...
  // infinite scroll
export const INFINITE_SCROLL_ROOT_MARGIN = '1800px'
