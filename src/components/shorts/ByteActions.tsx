...
<div className='flex p-2 bg-black/40 md:bg-inherit rounded-full justify-center  text-white md:text-black flex-col items-center  hover:text-rose-500 cursor-pointer' onClick={() => setisShowTipModal(! isShowTipModal)} >
...
<p className='text-sm md:font-semibold '>0</p>
         ...
         <div>
           <p>This  is comments place</p>
         </div>
               </SheetContent>
           </Sheet>
          <div className=' p-2 bg-black/50 md:bg-inherit rounded-full justify-center  text-white md:text-black flex flex-col items-center  hover:text-rose-500 cursor-pointer' onClick={() => setisShowTipModal(! isShowTipModal)} >
